...
// Initialize ImageKit client (you can use this later if you want to upload images/videos)
...
/**
 * Optional: upload to ImageKit if needed (currently not used)
 */
...
console.log(`Inserted book ${book.title}:`, result);
